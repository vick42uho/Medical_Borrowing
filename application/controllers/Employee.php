...
class Employee extends CI_Controller
{
	...
	public function index()
	{
		// print_r($_SESSION);
		$m_id = $_SESSION['m_id'];
		$data['query']=$this->Services_model->list_lend_member($m_id);
		...
		$this->load->view('template/backheader_emp');
		$this->load->view('employee/list_lend',$data);
	...
	public function profile()
	{
		...
		// exit;
		$this->load->view('template/backheader_emp');
		$this->load->view('employee/member_form_edit',$data);
		$this->load->view('template/backfooter_staff');
	}
	...
	public function pwd()
	{
		...
		// exit;
		$this->load->view('template/backheader_emp');
		$this->load->view('employee/member_form_pwd',$data);
		$this->load->view('template/backfooter_staff');
	}
  ...
  // 		echo '<pre>';
		...
		$this->Member_model->editemployeepwd();
	...
	public function devices()
	{
		...
		$this->load->view('template/backheader_emp');
		$this->load->view('employee/devices_list',$data);
		$this->load->view('template/backfooter_staff');
	}
