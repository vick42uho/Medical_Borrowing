<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            แสดงจำนวนการทำรายการการยืม-คืนอุปกรณ์ (แยกตามเดือน)
        </h1>
        <ol class="breadcrumb">
                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row" class="info">
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 65%;"><center>เดือน</center></th>
                                ...
                                <tbody>
                                    <?php foreach ($query as $row) { ?>
                                        <tr role="row">
                                            <td><?php echo date('M/Y',strtotime($row->mbr_datesave));?></td>
                                            <td align="center"><?php echo $row->total;?></td>
                                            <td>รายการ</td>

                                            <td align="center">

                                                <a href="<?php echo site_url('report/viewbymonth/'.date('m',strtotime($row->mbr_datesave))); ?>" target="_blank" class="btn btn-info btn-xs">
