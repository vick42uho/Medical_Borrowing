            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action="<?php echo  site_url('staff/add_lend4'); ?>" method="post" class="form-horizontal">
                            <div class="box-body">
                                ...
                                <form role="form" action="<?php echo  site_url('staff/add_lend4_db'); ?>" method="post" class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-sm-2 control-label">
                                            อุปกรณ์
                                        </div>
                                                ...
                                                <tbody>
                                                    <?php foreach ($ld as $rs) { ?>
                                                        <tr role="row">
                                                            ...
                                                            <td align="center">
                                                                <a href="<?php echo site_url('staff/edit_devices_img/'.$rs->no); ?>"><img src="<?php echo base_url('devices_img/'.$rs->d_img); ?>" width=100%></a>
                                                            </td>
