        ...
        <div class="box">
            <div class="box-header">
                <div class="login-logo">
                    <b>แสดงรายงานจำนวนเอกสารแยกตามประเภทหนังสือ</b>
                </div>
            </div><!-- /.box-header -->
            <div class="box-body">
                <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <a class="btn btn-success" href="<?php echo site_url('report/bytype_excel'); ?>" role="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp;&nbsp;Export to Excel</a>
                            <br />
