                ...
                <div class="col-sm-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <!-- form start -->
                            <form role="form" action="<?php echo  site_url('division/adddata'); ?>" method="post" class="form-horizontal">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="dname" required value="<?php echo set_value('dname'); ?>">
                                            <span class="fr"><?php echo form_error('dname'); ?></span>
                                        </div>
                                    </div>
