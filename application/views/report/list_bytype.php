<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            แสดงประวัติการยืม-คืน (แยกประเภท)
        </h1>
        <ol class="breadcrumb">
                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row" class="info">
                                        ...
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 80%;">ชื่อประเภท</th>
                                ...
                                <tbody>
                                    <?php foreach ($query as $row) { ?>
                                        <tr role="row">
                                            <td class="hidden" align="center"><?php echo $row->t_id;?></td>
                                            <td><?php echo $row->t_name;?></td>
                                            <td align="center"><?php echo $row->total;?></td>
                                            <td align="center">
                                                <?php if($row->total>0){ ?>
                                                    <a href="<?php echo site_url('report/viewbytype/'.$row->t_id); ?>" target="_blank" class="btn btn-info btn-xs">
                                                    เปิดดู </a>
                                                <?php } ?>
                                            </td>
