<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            แสดงจำนวนการทำรายการการยืม-คืนอุปกรณ์ (แยกตามวัน)
        </h1>
        <ol class="breadcrumb">
                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row" class="info">
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 70%;"><center>วัน/เดือน/ปี</center></th>
                                ...
                                <tbody>
                                    <?php foreach ($query as $row) { ?>
                                        <tr role="row">
                                            ...
                                            <td>รายการ</td>
                                            <td align="center">
                                              <!--a href="<?php // echo site_url('report/list_viewbyday/'.$row->datesave); ?>" target="_blank" class="btn btn-info btn-xs"-->
											  <a href="<?php echo site_url('report/viewbyday?datesave='.$row->datesave); ?>" target="_blank" class="btn btn-info btn-xs">
