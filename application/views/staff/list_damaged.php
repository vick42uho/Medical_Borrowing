<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ส่วนของเจ้าหน้าที่ดูแลอุปกรณ์การแพทย์ : แสดงข้อมูลอุปกรณ์ชำรุด
        </h1>
        <ol class="breadcrumb">
                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row" class="info">
                                        ...
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 15%;">วันที่บันทึกชำรุด</th>
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 15%;">หน่วยงานที่ยืม</th>
