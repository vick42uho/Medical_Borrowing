                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row" class="info">
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 65%;"><center>วัน/เดือน/ปี</center></th>
                                    ...
                                    <?php foreach ($query as $row) { ?>
                                        <tr role="row">
                                            ...
                                            <td align="center">
                                                    ...
                                                    <a href="<?php echo site_url('report/viewbyday/'.date('Y-m-d',strtotime($row->mbr_datesave))); ?>" target="_blank" class="btn btn-info btn-xs">
