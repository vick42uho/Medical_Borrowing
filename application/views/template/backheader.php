...
<head>
	...
	<!--Theme skin -->
	<?php echo link_tag('dist/css/skins/skin-green.min.css'); ?>
	<!--Theme skin -->
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="<?php echo $menus;?>">
						...
						<li class="<?php echo $menus;?>">
							...
							<ul class="treeview-menu">
								<li>
									<a href="<?php echo site_url('admin/devices');?>">
									...
									<ul class="treeview-menu">
										<li>
											<a href="<?php echo site_url('member');?>">
												<i class="fa fa-users" aria-hidden="true"></i> สมาชิก </a>
											</li>

											<li>
												<a href="<?php echo site_url('position');?>">
													<i class="fa fa-hospital-o" aria-hidden="true"></i> ตำแหน่งงาน </a>
												</li>

												<li>
													<a href="<?php echo site_url('division');?>">
														<i class="fa fa-university" aria-hidden="true"></i> หน่วยงาน </a>
													</li>
