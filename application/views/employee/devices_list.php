                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row" class="info">
                                        ...
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 23%;">ประเภท</th>
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 49%;">รายละเอียด</th>
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 6%;">สถานะ</th>
                                        <!-- <th  tabindex="0" rowspan="1" colspan="1" style="width: 6%;">ทำรายการ</th> -->
