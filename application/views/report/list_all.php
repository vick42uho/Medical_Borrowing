<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            แสดงข้อมูลประวัติการยืม-คืนอุปกรณ์ทั้งหมด
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                ...
                <br />
                <a href="<?php echo site_url('report/list_all_excel'); ?>" class="btn btn-info"><i class="fa fa-file-excel-o" aria-hidden="true"></i>  Export to Excel</a>
            </div><!-- /.box-header -->
            <div class="box-body">
                                ...
                                <tbody>
                                    <?php foreach ($query as $row) { ?>
                                        <tr role="row">
                                            ...
                                            <td align="center">
                                                ...
                                                echo date('d/m/Y',strtotime($row->mbr_date_lend));
                                                echo '</font>';
                                                ?>
                                            </td>
                                    ...
                                    <td>
                                        ...
                                        if ($dr==NULL) {
                                            ...
                                            echo date('d/m/Y',strtotime($row->mbr_date_return));
                                            echo '</font>';
                                        }
