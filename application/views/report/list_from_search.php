<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ฟอร์มเรียกดูข้อมูลประวัติการยืม-คืนอุปกรณ์ตามช่างวันที่
        </h1>
<!--         <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h3 class="box-title">
                                ...
                                echo date('d-m-Y',strtotime($_POST['ds'])); 
                                echo '</b></font>';
                                ?>
                                ถึง <?php 
                                echo '<font color="MediumVioletRed">';
                                echo date('d-m-Y',strtotime($_POST['de'])); 
                                echo '</b></font>';
                                ?>
                            </h3>
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                ...
                                <tbody>
                                    ...
                                    <td><?php echo '<font color="MediumVioletRed">';echo $row->mbr_staff_name_return; echo '</font>';?></td>
