<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo  site_url('employee'); ?>"><i class="fa fa-dashboard"></i> หน้าแรก</a></li>
            <li><a href="<?php echo  site_url('employee'); ?>"> จัดการสมาชิก </a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action="<?php echo  site_url('employee/edit_profile'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="ref_did" class="form-control" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="m_phone" class="form-control" required value="<?php echo $rsedit->m_phone; ?>" placeholder="เบอร์โทร" minlength="9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <button class="btn btn-primary" type="submit">
                                            ...
                                            <a class="btn btn-danger" href="<?php echo  site_url('employee'); ?>" role="button"><i class="fa fa-fw fa-close"></i> ยกเลิก</a>
