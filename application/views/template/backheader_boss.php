						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="<?php echo  site_url('boss/profile'); ?>" class="btn btn-default btn-flat">
											โปรไฟล์
										</a>
									</div>
				...
				<ul class="sidebar-menu">
					<li class="<?php echo $menus;?>">
						...
						<li class="<?php echo $menus;?>">
							...
							<ul class="treeview-menu">
								<li>
									<a href="<?php echo site_url('boss/devices');?>">
							...
							<li>
								...
								<ul class="treeview-menu">
									<li>
										<a href="<?php echo site_url('boss/profile');?>">
											<i class="fa fa-user" aria-hidden="true"></i> โปรไฟล์ </a>
										</li>
										<li>
											<a href="<?php echo site_url('boss/pwd');?>">
