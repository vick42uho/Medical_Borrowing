            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                                <form role="form" action="<?php echo  site_url('staff/edit_lend_db'); ?>" method="post" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <textarea name="mbr_reason" class="form-control" required><?php echo $rsedit->mbr_reason; ?></textarea>
