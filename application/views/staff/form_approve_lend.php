            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action="<?php echo  site_url('staff/approve_lend_db'); ?>" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <button class="btn btn-primary" type="submit">
                                        ...
                                        <a class="btn btn-danger" href="<?php echo  site_url('staff/lend_list'); ?>" role="button"><i class="fa fa-fw fa-close"></i> ยกเลิก</a>
