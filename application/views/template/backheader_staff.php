...
<head>
	...
	<!--Theme skin -->
	<?php echo link_tag('dist/css/skins/skin-purple.min.css'); ?>
	<!--Theme skin -->
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="<?php echo  site_url('staff/profile'); ?>" class="btn btn-default btn-flat">
											โปรไฟล์
										</a>
									</div>
...
<!-- 							<li><a href="<?php // echo site_url('staff/lend_list');?>">
								<i class="fa fa-retweet" aria-hidden="true"></i> รายการยืมอุปกรณ์</a></li> -->

							<li><a href="<?php echo site_url('staff/return_list');?>">
								<i class="fa fa-retweet" aria-hidden="true"></i> รายการคืนอุปกรณ์</a></li>


								<li><a href="<?php echo site_url('staff/damaged_list');?>">
									<i class="fa fa-wrench" aria-hidden="true"></i> รายการอุปกรณ์ชำรุด</a></li>

									<li><a href="<?php echo site_url('staff/repair_list');?>">
										<i class="fa fa-gavel" aria-hidden="true"></i> รายการอุปกรณ์ส่งซ่อม</a></li>
						...
						<!-- <li><a href="<?php // echo site_url('staff/lend_list');?>">
							...
							<li>
								...
								<ul class="treeview-menu">
									<li>
										<a href="<?php echo site_url('staff/profile');?>">
											<i class="fa fa-user" aria-hidden="true"></i> โปรไฟล์ </a>
										</li>
										<li>
											<a href="<?php echo site_url('staff/pwd');?>">
									...
									<li class="<?php echo $menus;?>">
										...
										<ul class="treeview-menu">
											<li>
												<a href="<?php echo site_url('staff/type');?>">
													<i class="fa fa-briefcase" aria-hidden="true"></i> ประเภทอุปกรณ์ </a>
												</li>
												<li>
													<a href="<?php echo site_url('staff/status');?>">
														<i class="fa fa-diamond" aria-hidden="true"></i> สถานะ </a>
													</li>
													<li>
														<a href="<?php echo site_url('staff/devices');?>">
															<i class="fa fa-medkit" aria-hidden="true"></i> อุปกรณ์ </a>
														</li>
														<li>
															<a target="_blank" href="<?php echo site_url('report');?>">
																<i class="fa fa-bar-chart" aria-hidden="true"></i> รายงาน </a>
															</li>
														</ul>
													</li>
													<li>
