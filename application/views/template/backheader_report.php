							...
							<ul class="treeview-menu">
								<li>
									<a href="<?php echo site_url('report');?>">
										<i class="fa fa-list-alt" aria-hidden="true"></i>ภาพรวม </a>
									</li>
									<li>
										<a href="<?php echo site_url('report/list_all');?>">
											<i class="fa fa-book" aria-hidden="true"></i> ประวัติการยืม-คืนอุปกรณ์ ทั้งหมด </a>
										</li>
										<li>
											<a href="<?php echo site_url('report/repair');?>">
												<i class="fa fa-wrench" aria-hidden="true"></i> ประวัติการส่งซ่อมอุปกรณ์ ทั้งหมด</a>
											</li>
										<!-- <li>
											<a href="<?php // echo site_url('report/bymember');?>">
												<i class="fa fa-list-alt" aria-hidden="true"></i> ประวัติการยืม-คืนอุปกรณ์ (รายคน) </a>
											</li> -->
<!-- 											<li>
												<a href="<?php // echo site_url('report/byposition');?>">
													<i class="fa fa-list-alt" aria-hidden="true"></i> ประวัติการยืม-คืนอุปกรณ์ (ตำแหน่ง) </a>
												</li> -->

												<li>
													<a href="<?php echo site_url('report/bydivision');?>">
														<i class="fa fa-users" aria-hidden="true"></i> ประวัติการยืม-คืนอุปกรณ์ (หน่วยงาน) </a>
													</li>


													<li>
														<a href="<?php echo site_url('report/bytype');?>">
															<i class="fa fa-tasks" aria-hidden="true"></i> ประวัติการยืม-คืนอุปกรณ์ (ประเภท) </a>
														</li>

														<li>
															<a href="<?php echo site_url('report/form');?>">
																<i class="fa fa-calendar-o" aria-hidden="true"></i> ค้นหาตามวัน </a>
															</li>
															<li>
																<a href="<?php echo site_url('report/byday');?>">
																	<i class="fa fa-calendar" aria-hidden="true"></i> แยกตามวัน </a>
																</li>
																<!-- <li>
																	<a href="<?php //echo site_url('report/bydaydivision');?>">
																		<i class="fa fa-calendar" aria-hidden="true"></i> แยกตามวัน (หน่วยงาน)</a>
																	</li> -->
																	<li>
																		<a href="<?php echo site_url('report/bymonth');?>">
																			<i class="fa fa-calendar-o" aria-hidden="true"></i> แยกตามเดือน </a>
																		</li>
																		<li>
																			<a href="<?php echo site_url('report/byyear');?>">
																				<i class="fa fa-calendar" aria-hidden="true"></i> แยกตามปี </a>
																			</li>


																	<!-- <li>
																		<a href="<?php // echo site_url('report/bydivision_chart');?>">
																			<i class="fa fa-pie-chart" aria-hidden="true"></i> กราฟหน่วยงาน </a>
																		</li> -->
																		<!-- <li>
																			<a href="<?php // echo site_url('report/bytype_chart');?>">
																				<i class="fa fa-pie-chart" aria-hidden="true"></i> กราฟประเภท </a>
																			</li> -->
